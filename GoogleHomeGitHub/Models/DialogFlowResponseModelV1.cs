...
namespace GoogleHomeGitHub.Models
{
    /// <summary>
    /// DialogFlow から渡ってくる JSON をパースする用
    /// </summary>
    /// 参考：https://github.com/chomado/GoogleHomeHack/blob/master/Models/DialogFlowResponseModel.cs
    public class DialogFlowResponseModelV1
    {
